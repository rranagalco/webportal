...
public class WDSFascorRequest_1220 extends WDSFascorRequestCommon implements WDSFascorRequest {
	private static Logger log = Logger.getLogger(WDSFascorRequest_1220.class);
	...
	public WDSFascorRequest_1220(HashMap<String, Object> rowHashMap) throws Exception {
		super(rowHashMap);
		parseData();
	}

	public WDSFascorRequest_1220(WDSFascorRequestCommon wdsFascorRequestCommon) throws Exception {
	...
	public int compareTo(Object object) {
		...
		if (object instanceof WDSFascorRequest_1220) {
			WDSFascorRequest_1220 wdsFascorRequest_1220Other = (WDSFascorRequest_1220) object;
			
			if (getOrder_num().compareTo(wdsFascorRequest_1220Other.getOrder_num()) != 0) {
				return getOrder_num().compareTo(wdsFascorRequest_1220Other.getOrder_num());
			} else {
				if (getLine_num() != wdsFascorRequest_1220Other.getLine_num()) {
					return ((getLine_num() > wdsFascorRequest_1220Other.getLine_num())?1:-1);
				} else {
