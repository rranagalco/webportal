	...
	public static void main(String[] args) {		
		...
		if (FascorProcessor.getDBConnections(60) == true) {
	        ...
	        try {
	    	    ...
	    	    String sqlStmt = 
	                   "select part_num from pub.part as prt where part_num <> '' order by part_num WITH (READPAST NOWAIT)";
            ...
            for (Iterator<HashMap<String, Object>> iterator = partAl.iterator(); iterator.hasNext();) {
            	...
            	try {
	                ...
	                log.error(part_num + ": updated UPC successfully.");
	                
				} catch (Exception e) {
					log.error(part_num + ": Failed to updat UPC, exception: " + e.getMessage());
