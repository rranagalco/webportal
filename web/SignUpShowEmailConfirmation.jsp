            ...
            <div class="row">
               ...
               <div class="row">
                  <div class="col-xs-12 text-center">
                     <h3>Thank you for creating a Galco account!</h3>
                     <p>A confirmation email has been sent to your email address. <br>Once confirmed, you will be able to access your account.</p>
                  </div>
               </div>
            </div>
         </div>
