   ...
   <div class="middle-sec">
      <main id="panel">
         <div class="container">
            <div class="row">
               <div class="col-xs-12">
                  <h1>Email Preference Change</h1>
               </div>
               <div class="row">
                  <div class="col-xs-12 text-center">
                     <h3 style="color: red; font-weight: bold;">Unable to change your e-mail preference!</h3>
                     <p>We are unable to change your e-mail preference, please call 1-800-575-5562.</p>
                  </div>
               </div>
            </div>
         </div>
