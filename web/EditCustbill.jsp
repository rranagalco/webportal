...
<head>
   ...
   <title>Add or Update Billing Address</title>
...
<body cz-shortcut-listen="true" class="create-account create-billing">
   ...
   <div class="middle-sec">
      <main id="panel">
         <div class="container addBillingContent">
            <div class="row">
               <div class="col-xs-12 col-sm-8">
                  <form role="form" action="/portal/controller?formFunction=<c:choose><c:when test="${addAddress != null}">AddCustbill</c:when><c:otherwise>EditCustbill</c:otherwise></c:choose>" id="SignUpBillForm" class="form-horizontal">
                  	 <h2 class="text-primary signin-header">Add a Billing Address</h2>
	                 ...
	                 <div class="form-group">
	                     ...
	                     <div class="col-xs-10 col-xs-offset-2 col-sm-11 col-sm-offset-0 col-md-8 input-group" style="padding-top: 8px;">
	                        ...
	                        <label for="makeDefault">Make this my default billing address</label>
	                     </div>
	                 </div>
                     ...
                     <div class="form-group">
                        <div class="col-xs-12 col-sm-11 col-md-7 col-md-offset-4 col-lg-8 input-group">
                           <button id="addOrUpdateAddressButton" class="btn btn-block btn-primary"><c:choose><c:when test="${addAddress != null}">Add Billing Address</c:when><c:otherwise>Update Billing Address</c:otherwise></c:choose></button>
                        </div>
                     </div>

					 <input type="hidden" name="formFunction" value="<c:choose><c:when test="${addAddress != null}">AddCustbill</c:when><c:otherwise>EditCustbill</c:otherwise></c:choose>">
                     <input type="hidden" name="billto_num" <c:choose><c:when test="${billto_num != null}">value="${billto_num}"</c:when><c:otherwise>value=""</c:otherwise></c:choose>>
