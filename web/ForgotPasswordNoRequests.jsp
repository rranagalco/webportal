...
<h4 class="text-center">There are no pending password reset requests for this user name, ${username}, please go to www.galco.com and submit a password change request.</h4>
