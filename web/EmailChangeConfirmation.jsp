            ...
            <div class="row">
               ...
               <div class="row">
                  <div class="col-xs-12 text-center">
                     <h3>We changed your e-mail address.</h3>
                     <p>A confirmation email has been sent to your new email address. <br>Once confirmed, you will be able to access your account.</p>
                  </div>
               </div>
            </div>
         </div>
