...
<form id="SignUpForm" action="/portal/controller?formFunction=UpdateAccountInfo">
    ...
    <h5 style="padding-left:0em;">Current Email Address: ${userSignUpData.email}</h5>
    <p/>
    <a style="padding-left:0em;" href="/portal/controller?formFunction=ChangeEmail" >Update e-mail address</a>
                   ...
                   <div class="addressRow row selectedAddress" data-shipto="02">
                      ...
                      <div class="backgroundColor">
                         ...
                         <div class="col-xs-12 col-sm-9 addressBlock">
                            ...
                            <a href="/portal/controller?formFunction=EditCustbills&profileEditing=Y" >Add, or Update, billing addresses</a>
                         </div>
                      </div>
                   </div>
                   ...
                   <div class="addressRow row selectedAddress" data-shipto="02">
                      ...
                      <div class="backgroundColor">
                         ...
                         <div class="col-xs-12 col-sm-9 addressBlock">
                            ...
                            <a href="/portal/controller?formFunction=EditCustships&profileEditing=Y" >Add, or Update, shipping addresses</a>
                         </div>
                      </div>
                   </div>
    ...
    <a href="/portal/controller?formFunction=EmailPreferences" >Update e-mail preferences</a>
    ...
    <div class="form-group row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <h3 class="form-signin-heading">Main customer information</h5>
        </div>
    </div>
